...
namespace FluentUI
{
    ...
    {
        private static readonly Dictionary<Type, System.Collections.Generic.List<PropertyInfo>> _propertyDictionary = new();
        private static readonly Dictionary<PropertyInfo, System.Collections.Generic.List<Attribute>> _attributeDictionary = new();
        ...
        {
            LocalCSSheets = new System.Collections.Generic.List<ILocalCSSheet>();
            GlobalCSSheets = new ObservableCollection<IGlobalCSSheet>();
            GlobalCSSheets.CollectionChanged += CollectionChanged;
            GlobalRulesSheets = new System.Collections.Generic.List<IGlobalCSSheet>();
            GlobalCSRules = new System.Collections.Generic.List<string>();
        }
        ...
        private static System.Collections.Generic.List<PropertyInfo> GetCachedProperties(Type type)
        {
            System.Collections.Generic.List<PropertyInfo> properties;
        ...
        {
            Attribute? attribute = null;
            System.Collections.Generic.List<Attribute> attributes;
