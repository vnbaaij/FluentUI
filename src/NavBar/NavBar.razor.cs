...
namespace FluentUI
{
    public partial class NavBar : FluentUIComponentBase
    {
        ...
        [Parameter] public IEnumerable<INavBarItem> Items { get; set; } = new System.Collections.Generic.List<NavBarItem>();
        [Parameter] public IEnumerable<INavBarItem> OverflowItems { get; set; } = new System.Collections.Generic.List<NavBarItem>();
        ...
        protected override Task OnParametersSetAsync()
        {
            ...
            {
                PrimaryItems = new System.Collections.Generic.List<INavBarItem>(Items ?? new System.Collections.Generic.List<INavBarItem>()),
                OverflowItems = new System.Collections.Generic.List<INavBarItem>(OverflowItems ?? new System.Collections.Generic.List<INavBarItem>()),
