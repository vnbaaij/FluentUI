...
namespace FluentUI
{
    public partial class CalloutContent : FluentUIComponentBase, IAsyncDisposable
    {
        ...
        #region Style
        private ICollection<IRule> CalloutLocalRules { get; set; } = new System.Collections.Generic.List<IRule>();

        private readonly Rule CalloutRule = new();
        private readonly Rule CalloutMainRule = new();
        private readonly Rule CalloutBeakRule = new();
        #endregion
        ...
        private ElementPosition AdjustFitWithinBounds(Rectangle element, Rectangle target, Rectangle bounding, PositionDirectionalHintData positionData, double gap = 0)
        {
            ...
            System.Collections.Generic.List<RectangleEdge> outOfBounds = GetOutOfBoundsEdges(element, bounding);
            if (alignTargetEdge)
            {
        ...
        private ElementPosition FlipToFit(Rectangle rect, Rectangle target, Rectangle bounding, PositionDirectionalHintData positionData, double gap = 0)
        {
            ...
            System.Collections.Generic.List<RectangleEdge> directions = new() { RectangleEdge.Left, RectangleEdge.Right, RectangleEdge.Bottom, RectangleEdge.Top };
        ...
        private static System.Collections.Generic.List<RectangleEdge> GetOutOfBoundsEdges(Rectangle rect, Rectangle boundingRect)
        {
            System.Collections.Generic.List<RectangleEdge> outOfBounds = new();
        ...
        readonly Dictionary<DirectionalHint, PositionDirectionalHintData> DirectionalDictionary = new() {
