...
namespace FluentUI
{
    public partial class CommandBar : FluentUIComponentBase
    {
        ...
        protected override Task OnParametersSetAsync()
        {
            ...
            {
                PrimaryItems = new System.Collections.Generic.List<ICommandBarItem>(Items ?? new System.Collections.Generic.List<ICommandBarItem>()),
                OverflowItems = new System.Collections.Generic.List<ICommandBarItem>(OverflowItems ?? new System.Collections.Generic.List<ICommandBarItem>()),
                FarItems = new System.Collections.Generic.List<ICommandBarItem>(FarItems ?? new System.Collections.Generic.List<ICommandBarItem>()),
