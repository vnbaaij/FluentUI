...
namespace FluentUI
{
...

    {
        ...
        readonly System.Collections.Generic.List<object> suggestions = new();
        protected bool isOpen { get; set; }

        TextField textFieldRef;
        readonly System.Collections.Generic.List<SelectedItem<T>> selectedItemsVisuals = new();

        private ICollection<IRule> DropdownLocalRules { get; set; } = new System.Collections.Generic.List<IRule>();
        ...
        void ClickedSelectHandler(SearchItem<T> searchItem)
        {
            if (IsMultiSelect)
            {
                ...
                {
                    SelectedItems = new System.Collections.Generic.List<T>();
                }
