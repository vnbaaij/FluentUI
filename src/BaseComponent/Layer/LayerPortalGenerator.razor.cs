...
namespace FluentUI
{
    public partial class LayerPortalGenerator : ComponentBase
    {
        ...
        private readonly Dictionary<string, int> portalSequenceStarts = new();
        private readonly System.Collections.Generic.List<PortalDetails> portalFragments = new();
        private readonly Dictionary<string, LayerPortal> portals = new();
